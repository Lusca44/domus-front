  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Tradição • Modernidade • Pertencimento</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <Button 
                ...
                onClick={() => document.getElementById('form-interesse')?.scrollIntoView({behavior: 'smooth'})}
              >
                Tenho Interesse
              </Button>
            </div>
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url("/assets/lancamentos/nova-olaria/background-nova-olaria.jpg")',
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          <p className="text-lg md:text-xl text-orange-100 mb-8 max-w-2xl mx-auto leading-relaxed">
            Tradição e modernidade se encontram no coração de Olaria. 
            Amplo lazer, localização estratégica e a qualidade CURY.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              ...
              onClick={() => document.getElementById('carrossel')?.scrollIntoView({behavior: 'smooth'})}
            >
              Ver Fotos
            </Button>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              No coração de Olaria, onde a história encontra o futuro, 
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-orange-50 to-red-50 border border-orange-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Localização Estratégica</h3>
              <p className="text-gray-600">
                Próximo ao BRT Fiscal de Ramos, Colégio Pedro II e Shopping Nova América
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-orange-50 to-red-50 border border-orange-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Amplo Lazer</h3>
              <p className="text-gray-600">
                Piscinas, campo society, fitness externo e muito mais para toda família
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-orange-50 to-red-50 border border-orange-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Qualidade CURY</h3>
              <p className="text-gray-600">
      ...
      {/* Carrossel de Fotos */}
      <section id="carrossel" className="py-16 bg-gradient-to-br from-orange-50 to-red-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-yellow-50 to-yellow-100 border border-yellow-200 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-sm text-gray-600">Celebre momentos especiais</p>
            </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-700">Área: 38,50m² a 41,34m²</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-orange-600 rounded-full"></div>
                      <span className="text-gray-700">2 quartos com possibilidade de suíte</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-orange-600 rounded-full"></div>
                    ...
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-orange-600 rounded-full"></div>
                      <span className="text-gray-700">Cozinha e área de serviço</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-orange-600 rounded-full"></div>
              ...
              <div>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">BRT Fiscal de Ramos</h3>
                      <p className="text-gray-600">Conexão rápida com toda a cidade</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">Colégio Pedro II</h3>
                      <p className="text-gray-600">Educação de qualidade próxima</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">Shopping Nova América</h3>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">Parques e Lazer</h3>
                      <p className="text-gray-600">Área verde e qualidade de vida</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="bg-white/90 backdrop-blur-sm rounded-lg p-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="font-medium text-gray-900">Olaria, Rio de Janeiro</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="form-interesse" className="py-16 bg-gradient-to-br from-orange-600 to-red-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-orange-100">
                Preencha o formulário e receba informações exclusivas sobre preços, plantas e condições especiais
              </p>
            </div>

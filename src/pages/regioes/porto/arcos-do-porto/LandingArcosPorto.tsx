...
import { MapPin, Home, Users, Car, Waves, Building2, Ship, Anchor, ArrowLeft } from "lucide-react";
...
const LandingArcosPorto = () => {
  ...
  const backgroundImage = "/assets/lancamentos/arcos-do-porto/background-arcos-porto.jpg";
...
export default LandingArcosPorto;

          ...
          {filteredProperties.length > 0 && (
            <div className="text-center mb-6">
              <p className="text-gray-600">
                {hasActiveFilters ? `${filteredProperties.length} aluguéis encontrados` : `${filteredProperties.length} aluguéis disponíveis`}
                {hasActiveFilters && (
                  <Button
                    onClick={clearFilters}
                    variant="link"
              ...
              {!hasMoreItems && filteredProperties.length > 4 && (
                <div className="text-center mt-12">
                  <p className="text-gray-500">
                    Você visualizou todos os {filteredProperties.length} imóveis{hasActiveFilters ? ' que atendem aos filtros selecionados' : ' disponíveis para aluguel'}.
                  </p>
                </div>
              )}
            </>

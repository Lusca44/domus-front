        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
              Encontre o imóvel perfeito para alugar nas melhores regiões do Rio
              de Janeiro.
            </p>
          </div>
          ...
          {filteredProperties.length > 0 && (
            <div className="text-center mb-6">
              <p className="text-gray-600">
                {hasActiveFilters
                  ? `${filteredProperties.length} aluguéis encontrados`
                  : `${filteredProperties.length} aluguéis disponíveis`}
                {hasActiveFilters && (
                  <Button
                    onClick={clearFilters}
                    variant="link"
              ...
              {!hasMoreItems && filteredProperties.length > 4 && (
                <div className="text-center mt-12">
                  <p className="text-gray-500">
                    Você visualizou todos os {filteredProperties.length} imóveis
                    {hasActiveFilters

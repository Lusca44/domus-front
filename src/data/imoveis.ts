...
export const getLancamentos = () =>
  todosImoveis.filter((imovel) => imovel.tipo === "lancamento");
export const getAlugueis = () =>
  todosImoveis.filter((imovel) => imovel.tipo === "aluguel");
export const getCompraVenda = () =>
  todosImoveis.filter((imovel) => imovel.tipo === "compra-venda");
